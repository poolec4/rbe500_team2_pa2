...
// (in-package forward_kinematics.msg)
...
class scara_robot_pose {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new scara_robot_pose(null);
  ...
  static datatype() {
    ...
    return 'forward_kinematics/scara_robot_pose';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new scara_robot_pose(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = scara_robot_pose;
