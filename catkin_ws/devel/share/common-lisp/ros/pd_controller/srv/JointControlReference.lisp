...
(cl:in-package pd_controller-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <JointControlReference-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointControlReference-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pd_controller-srv:<JointControlReference-request> is deprecated: use pd_controller-srv:JointControlReference-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <JointControlReference-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pd_controller-srv:x-val is deprecated.  Use pd_controller-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <JointControlReference-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pd_controller-srv:y-val is deprecated.  Use pd_controller-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <JointControlReference-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pd_controller-srv:z-val is deprecated.  Use pd_controller-srv:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointControlReference-request>)))
  ...
  "pd_controller/JointControlReferenceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointControlReference-request)))
  "Returns string type for a service object of type 'JointControlReference-request"
  "pd_controller/JointControlReferenceRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <JointControlReference-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointControlReference-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pd_controller-srv:<JointControlReference-response> is deprecated: use pd_controller-srv:JointControlReference-response instead.")))

(cl:ensure-generic-function 'theta1-val :lambda-list '(m))
(cl:defmethod theta1-val ((m <JointControlReference-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pd_controller-srv:theta1-val is deprecated.  Use pd_controller-srv:theta1 instead.")
  (theta1 m))

(cl:ensure-generic-function 'theta2-val :lambda-list '(m))
(cl:defmethod theta2-val ((m <JointControlReference-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pd_controller-srv:theta2-val is deprecated.  Use pd_controller-srv:theta2 instead.")
  (theta2 m))

(cl:ensure-generic-function 'd3-val :lambda-list '(m))
(cl:defmethod d3-val ((m <JointControlReference-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pd_controller-srv:d3-val is deprecated.  Use pd_controller-srv:d3 instead.")
  (d3 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointControlReference-response>)))
  ...
  "pd_controller/JointControlReferenceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointControlReference-response)))
  "Returns string type for a service object of type 'JointControlReference-response"
  "pd_controller/JointControlReferenceResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointControlReference)))
  ...
  "pd_controller/JointControlReference")